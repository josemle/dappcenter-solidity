...
// TODO: restore tests
contract.skip("DAO", function(accounts) {
  ...
  //     const transactionBytes = contract.methods
  //       .addMember(accounts[i], 1000000)
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  //       0
  //     );
  ...
  //       await itSendsOneMemberEverythingWhen(
  //         web3Helpers.toWei("2", "ether"),
  //         accounts
  //       );
  //     });
  //     it("sends the one member everything when -1", async () => {
  //       await itSendsOneMemberEverythingWhen(
  //         web3Helpers.toWei("2", "ether").minus(1),
  //         accounts
  //       );
  //     });
  //     it("sends the one member everything when +1", async () => {
  //       await itSendsOneMemberEverythingWhen(
  //         web3Helpers.toWei("2", "ether").plus(1),
  //         accounts
  //       );
  //     });
  //     it("sends the one member everything when 1", async () => {
  //       await itSendsOneMemberEverythingWhen(
  //         web3Helpers.toWei("1", "ether").plus(1),
  //         accounts
  //       );
  //     });
  ...
  //     );
  //     assert.isTrue(
  //       await testHelpers.doesThrow(
  //         instance.executeProposal(proposal.logs[0].args.proposalId)
  //       )
  //     );
  //   });
  ...
  //     assert.isTrue(
  //       await testHelpers.isLength(instance.members, accounts.length)
  //     );
  //   });
  //   it("can remove a member after voting", async () => {
  //     await setupOwners(3);
  //     const transactionBytes = contract.methods
  //       .removeMember(accounts[1])
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  ...
  //     const proposalId = proposal.logs[0].args.proposalId;
  //     assert.isTrue(
  //       await testHelpers.doesThrow(instance.executeProposal(proposalId))
  //     );
  ...
  //     await setupOwners(3);
  //     const transactionBytes = contract.methods
  //       .swapMember(accounts[1], accounts[6])
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  ...
  //     await setupOwners(3);
  //     const transactionBytes = contract.methods
  //       .setMemberWeights([accounts[0], accounts[2]], [1, 42])
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  ...
  //     await setupOwners(3);
  //     let transactionBytes = contract.methods
  //       .setTimeTillMinorityCanExecute(TWO_WEEKS * 0.5)
  //       .encodeABI();
  //     let proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  //       0
  //     );
  ...
  //     transactionBytes = contract.methods
  //       .addMember(accounts[6], 1000000)
  //       .encodeABI();
  //     proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  //       0
  //     );
  ...
  //       await testHelpers.doesThrow(instance.executeProposal(proposalId))
  //     );
  //     await web3Helpers.increaseTime(TWO_WEEKS * 0.5 + 1);
  //     assert.isFalse(
  //       await testHelpers.doesThrow(instance.executeProposal(proposalId))
  //     );
  //   });
  ...
  //     await setupOwners(1);
  //     let transactionBytes = contract.methods
  //       .setTimeTillExpired(TWO_WEEKS + 1)
  //       .encodeABI();
  //     let proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  ...
  //       await web3Helpers.getBalanceChangeAfterGas(
  //         () => instance.withdrawl(),
  //         accounts[0]
  //       )
  //     );
  ...
  //     const delta1 = await web3Helpers.getBalanceChangeAfterGas(
  //       () => instance.withdrawl(),
  //       accounts[0]
  //     );
  ...
  //     const transactionBytes = contract.methods
  //       .send(accounts[6], ONE_ETHER.toString())
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       instance.address,
  //       transactionBytes,
  ...
  //     await instance.send(TWO_ETHER.toString());
  //     assert.equal(
  //       (await instance.estimateWithdrawl({ from: accounts[0] })).toString(),
  //       ONE_ETHER.times(60)
  //         .dividedToIntegerBy(100)
  //         .toString()
  //     );
  //     assert.equal(
  //       (await instance.estimateWithdrawl({ from: accounts[1] })).toString(),
  //       ONE_ETHER.times(30)
  //         .dividedToIntegerBy(100)
  //         .toString()
  //     );
  //     assert.equal(
  //       (await instance.estimateWithdrawl({ from: accounts[2] })).toString(),
  //       ONE_ETHER.times(10)
  //         .dividedToIntegerBy(100)
  //         .toString()
  //     );
  ...
  //     basicContract = web3Helpers.getContract(
  //       basicInstance.abi,
  //       basicInstance.address
  //     );
  //   });
  //   it("function() payable", async () => {
  //     const transactionBytes = contract.methods
  //       .send(basicInstance.address, ONE_ETHER.toString())
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       basicInstance.address,
  //       transactionBytes,
  ...
  //     await instance.send(TWO_ETHER.toString());
  //     const transactionBytes = basicContract.methods
  //       .test42Payable(42)
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       basicInstance.address,
  ...
  //     exampleERC20Contract = web3Helpers.getContract(
  //       exampleERC20Instance.abi,
  ...
  //     await setupOwners(1);
  //     assert.equal(
  //       (await exampleERC20Instance.balanceOf(accounts[0])).toString(),
  //       startingBalance.toString()
  //     );
  //     await exampleERC20Instance.transfer(
  //       instance.address,
  //       startingBalance.toString()
  //     );
  //     assert.equal(
  ...
  //     );
  //     assert.equal(
  //       (await exampleERC20Instance.balanceOf(instance.address)).toString(),
  //       startingBalance.toString()
  //     );
  //     const transactionBytes = exampleERC20Contract.methods
  //       .transfer(accounts[6], startingBalance.toString())
  //       .encodeABI();
  //     const proposal = await instance.addProposal(
  //       exampleERC20Instance.address,
  //       transactionBytes,
  ...
  //     await instance.executeProposal(proposalId);
  //     assert.equal(
  //       (await exampleERC20Instance.balanceOf(accounts[6])).toString(),
  //       startingBalance.toString()
  //     );
  //   });
  //   it("distributes by weight 60/30/10", async () => {
  ...
  //     assert.equal(
  //       (await exampleERC20Instance.balanceOf(accounts[2])).toString(),
  //       startingBalance
  //         .times(10)
  //         .dividedToIntegerBy(100)
  //         .toString()
  //     );
  //     assert.equal(
  //       (await exampleERC20Instance.balanceOf(accounts[1])).toString(),
  //       startingBalance
  //         .times(30)
  //         .dividedToIntegerBy(100)
  //         .toString()
  ...
  //     await instance.executeProposal(proposalId);
  //     assert.equal(
  //       (await instance.estimateWithdrawlERC20(exampleERC20Instance.address, {
  //         from: accounts[0]
  //       })).toString(),
  //       startingBalance
  //         .times(60)
...
// async function itSendsOneMemberEverythingWhen(amount, accounts) {
